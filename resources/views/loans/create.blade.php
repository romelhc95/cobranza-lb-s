                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('loans.store') }}" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <select type="text" name="user_id" class="form-control" required>
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}">{{ old('loan', $user->full_name) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="payment_number" class="form-control" id="payment_number" placeholder="Ingrese la cuota">
