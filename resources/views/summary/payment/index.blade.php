...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">Recaudado del día <strong>{{ Str::substr($summary[0]->created_at, 8, 2)}}-{{ Str::substr($summary[0]->created_at, 5, 2) }}-{{ Str::substr($summary[0]->created_at, 0, 4) }}</strong>&nbsp;&nbsp;&nbsp;
